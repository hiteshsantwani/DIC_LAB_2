...
// based on kpshadoop.blogspot.com/2014/06/word-co-occurrence-problem.html
public class WordCooccurPairs {
    ...
    extends Mapper<Object, Text, Text, IntWritable>{
        ...
        public void map(Object key, Text value, Context context
            ...
            // pre processing code should go here
            ...
            for(int i=0; i<=tokens.length-1;i++){
                for(int j=1; i+j<=tokens.length-1;j++){ 
                    if(tokens[i].contains("\\>") ||
                        ...
                        continue;    // Pre preocessing step to remove the emojis , numbers , co , u, RT , blank , single character as the first token
                    }
